...
| runtime.preTraining.mpiDistributed.enable | bool | `true` |  |
| runtime.preTraining.mpiDistributed.image.registry | string | `"docker.io"` |  |
| runtime.preTraining.mpiDistributed.image.repository | string | `"busybox"` |  |
| runtime.preTraining.mpiDistributed.image.tag | string | `"latest"` |  |
