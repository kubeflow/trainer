...
| dataCache.lws.install | bool | `false` | Whether to install LeaderWorkerSet as a dependency managed by trainer. This must be set to `false` if LeaderWorkerSet controller/webhook has already been installed into the cluster. |
