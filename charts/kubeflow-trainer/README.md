...
| manager.config.tls | object | `{}` | TLS configuration for webhook and metrics servers. Values here can be overridden at runtime via --tls-min-version and --tls-cipher-suites flags. |
