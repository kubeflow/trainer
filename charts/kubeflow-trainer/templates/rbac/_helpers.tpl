...
*/}}
{{- define "trainer.controller.serviceAccount.name" -}}
...
*/}}
{{- define "trainer.controller.clusterRole.name" -}}
{{ include "trainer.controller.name" . }}
{{- end -}}
...
*/}}
{{- define "trainer.controller.clusterRoleBinding.name" -}}
{{ include "trainer.controller.name" . }}
{{- end -}}
...
*/}}
{{- define "trainer.controller.role.name" -}}
{{ include "trainer.controller.name" . }}
{{- end -}}
...
*/}}
{{- define "trainer.controller.roleBinding.name" -}}
{{ include "trainer.controller.name" . }}
{{- end -}}
