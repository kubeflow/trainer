    ...
    "announcement": """
        <nav class="top-nav">
            ...
            <div class="top-nav-links">
                <a href="https://github.com/kubeflow/trainer/blob/master/examples/pytorch/image-classification/mnist.ipynb">Examples</a>
                <a href="https://github.com/kubeflow/trainer">GitHub</a>
                <a href="https://kubeflow.slack.com">Slack</a>
                <a href="https://blog.kubeflow.org/trainer/intro/">Blog</a>
            </div>
        </nav>
    """,
}
