...
:::{tip}
This content is sourced from the [CONTRIBUTING.md on GitHub](https://github.com/kubeflow/trainer/blob/master/CONTRIBUTING.md).
:::
...
The PR titles are used to generate changelog for releases.
...
the [docs/proposals](https://github.com/kubeflow/trainer/tree/master/docs/proposals) directory.
...
- Run [`make generate`](https://github.com/kubeflow/trainer/blob/master/Makefile) locally to verify if changes follow best practices before submitting PRs.
...
Changes to the Kubeflow Trainer Python SDK can be made in the [kubeflow/sdk](https://github.com/kubeflow/sdk) repo.

The Trainer SDK can be found at [kubeflow/sdk/tree/main/kubeflow/trainer](https://github.com/kubeflow/sdk/tree/main/kubeflow/trainer).
