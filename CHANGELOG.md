...
## [v2.2.5](https://github.com/kubeflow/trainer/releases/tag/v2.2.5) (2026-05-12)

This is Kubeflow Trainer v2.2.5 release.

```bash
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/manager?ref=v2.2.5"
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/runtimes?ref=v2.2.5"
```

You can now install controller manager with Helm charts 🚀

```bash
helm install kubeflow-trainer oci://ghcr.io/kubeflow/charts/kubeflow-trainer --version 2.2.5
```
...
- feat(api): Replace PodTemplateOverrides with RuntimePatches API  ([#3309](https://github.com/kubeflow/trainer/pull/3309) by @astefanutti)
...
- feat(release): update release documentation and remove changelog generation script (@milinddethe15)
...
### New Contributors
* @andreyvelich made their first contribution in [#3242](https://github.com/kubeflow/trainer/pull/3242)
* @Goku2099 made their first contribution in [#3253](https://github.com/kubeflow/trainer/pull/3253)
* @XploY04 made their first contribution in [#3434](https://github.com/kubeflow/trainer/pull/3434)
* @sameerdattav made their first contribution in [#3276](https://github.com/kubeflow/trainer/pull/3276)
* @sunalawa made their first contribution in [#3376](https://github.com/kubeflow/trainer/pull/3376)
* @jaiakash made their first contribution in [#3218](https://github.com/kubeflow/trainer/pull/3218)
* @dependabot[bot] made their first contribution in [#3426](https://github.com/kubeflow/trainer/pull/3426)
* @Fiona-Waters made their first contribution in [#3418](https://github.com/kubeflow/trainer/pull/3418)
* @vsoch made their first contribution in [#3325](https://github.com/kubeflow/trainer/pull/3325)
* @kaisoz made their first contribution in [#3360](https://github.com/kubeflow/trainer/pull/3360)
* @ghazariann made their first contribution in [#3307](https://github.com/kubeflow/trainer/pull/3307)
* @astefanutti made their first contribution in [#3319](https://github.com/kubeflow/trainer/pull/3319)
* @Krishna-kg732 made their first contribution in [#3323](https://github.com/kubeflow/trainer/pull/3323)
* @robert-bell made their first contribution in [#3227](https://github.com/kubeflow/trainer/pull/3227)
* @Amir380-A made their first contribution in [#3283](https://github.com/kubeflow/trainer/pull/3283)
* @krishdef7 made their first contribution in [#3301](https://github.com/kubeflow/trainer/pull/3301)
