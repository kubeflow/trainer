...
type PodTemplateOverrideApplyConfiguration struct {
	...
	Metadata   *PodTemplateMetadataOverrideApplyConfiguration   `json:"metadata,omitempty"`
...
func (b *PodTemplateOverrideApplyConfiguration) WithMetadata(value *PodTemplateMetadataOverrideApplyConfiguration) *PodTemplateOverrideApplyConfiguration {
	b.Metadata = value
	return b
}
