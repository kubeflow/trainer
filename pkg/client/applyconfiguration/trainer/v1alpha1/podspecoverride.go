...
func (b *PodSpecOverrideApplyConfiguration) WithLabels(entries map[string]string) *PodSpecOverrideApplyConfiguration {
...
func (b *PodSpecOverrideApplyConfiguration) WithAnnotations(entries map[string]string) *PodSpecOverrideApplyConfiguration {
