...
func SetupServer(mgr ctrl.Manager, cfg *configapi.StatusServer, tlsOpts *configapi.TLSOptions, enableHTTP2 bool) error {
	tlsConfig, err := cert.SetupTLSConfig(mgr, enableHTTP2, tlsOpts)
	if err != nil {
		return err
	}
