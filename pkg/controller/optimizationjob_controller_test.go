...
func TestConstructAlgorithmDeployment(t *testing.T) {
	...
	if c.ReadinessProbe == nil || c.ReadinessProbe.TCPSocket == nil {
		t.Fatalf("expected TCPSocket readiness probe, got nil")
	}
	...
	if c.ReadinessProbe.TCPSocket.Port.IntVal != constants.SearchAlgorithmServicePort {
		t.Errorf("expected TCP port %d, got %d", constants.SearchAlgorithmServicePort, c.ReadinessProbe.TCPSocket.Port.IntVal)
	}
