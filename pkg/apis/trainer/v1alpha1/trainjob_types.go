...
type PodTemplateOverride struct {
	...
	// This can be used by external controllers (such as Kueue) or admission webhooks to track which entries they own
	// and avoid conflicts with other controllers.
	// +optional
