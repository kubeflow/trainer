...
// which contains this label: `trainer.kubeflow.org/trainjob-ancestor: dataset-initializer`
...
// which contains this label: `trainer.kubeflow.org/trainjob-ancestor: trainer`
type Trainer struct {
