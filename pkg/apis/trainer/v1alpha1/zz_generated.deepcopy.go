...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectiveMetricValue) DeepCopyInto(out *ObjectiveMetricValue) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectiveMetricValue.
func (in *ObjectiveMetricValue) DeepCopy() *ObjectiveMetricValue {
	if in == nil {
		return nil
	}
	out := new(ObjectiveMetricValue)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OptimalTrial) DeepCopyInto(out *OptimalTrial) {
	*out = *in
	if in.Metrics != nil {
		...
		*out = make([]ObjectiveMetricValue, len(*in))
		copy(*out, *in)
	}
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
