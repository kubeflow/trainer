...
func (in *Trainer) DeepCopyInto(out *Trainer) {
	*out = *in
	...
	if in.ResourceClaimsPerNode != nil {
		in, out := &in.ResourceClaimsPerNode, &out.ResourceClaimsPerNode
		*out = make([]TrainerResourceClaim, len(*in))
		copy(*out, *in)
	}
	if in.NumProcPerNode != nil {
		in, out := &in.NumProcPerNode, &out.NumProcPerNode
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrainerResourceClaim) DeepCopyInto(out *TrainerResourceClaim) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrainerResourceClaim.
func (in *TrainerResourceClaim) DeepCopy() *TrainerResourceClaim {
	if in == nil {
		return nil
	}
	out := new(TrainerResourceClaim)
	in.DeepCopyInto(out)
	return out
}
