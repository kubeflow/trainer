...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KAIPodGroupPolicySource) DeepCopyInto(out *KAIPodGroupPolicySource) {
	*out = *in
	if in.QueueName != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KAIPodGroupPolicySource.
func (in *KAIPodGroupPolicySource) DeepCopy() *KAIPodGroupPolicySource {
	if in == nil {
		return nil
	}
	out := new(KAIPodGroupPolicySource)
	in.DeepCopyInto(out)
	return out
}
