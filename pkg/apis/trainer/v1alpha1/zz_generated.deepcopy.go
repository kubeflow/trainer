...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodTemplateMetadataOverride) DeepCopyInto(out *PodTemplateMetadataOverride) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodTemplateMetadataOverride.
func (in *PodTemplateMetadataOverride) DeepCopy() *PodTemplateMetadataOverride {
	if in == nil {
		return nil
	}
	out := new(PodTemplateMetadataOverride)
	in.DeepCopyInto(out)
	return out
}
