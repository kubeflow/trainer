...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProgressionStatus) DeepCopyInto(out *ProgressionStatus) {
	*out = *in
	...
	if in.PercentageComplete != nil {
		in, out := &in.PercentageComplete, &out.PercentageComplete
		*out = new(string)
		**out = **in
	}
	...
	if in.TrainingMetrics != nil {
		in, out := &in.TrainingMetrics, &out.TrainingMetrics
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProgressionStatus.
func (in *ProgressionStatus) DeepCopy() *ProgressionStatus {
	if in == nil {
		return nil
	}
	out := new(ProgressionStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TrainJobStatus) DeepCopyInto(out *TrainJobStatus) {
	*out = *in
	...
	if in.ProgressionStatus != nil {
		in, out := &in.ProgressionStatus, &out.ProgressionStatus
		*out = new(ProgressionStatus)
		(*in).DeepCopyInto(*out)
	}
	return
...
func (in *TrainingMetrics) DeepCopyInto(out *TrainingMetrics) {
	*out = *in
	...
	if in.CheckpointsStored != nil {
		in, out := &in.CheckpointsStored, &out.CheckpointsStored
		*out = new(int64)
		**out = **in
	}
	if in.LatestCheckpointPath != nil {
		in, out := &in.LatestCheckpointPath, &out.LatestCheckpointPath
		*out = new(string)
		**out = **in
	}
	if in.Accuracy != nil {
