...
func (in *Configuration) DeepCopyInto(out *Configuration) {
	*out = *in
	...
	if in.TrainJobStatusServer != nil {
		in, out := &in.TrainJobStatusServer, &out.TrainJobStatusServer
		*out = new(TrainJobStatusServer)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrainJobStatusServer) DeepCopyInto(out *TrainJobStatusServer) {
	*out = *in
	if in.Port != nil {
		in, out := &in.Port, &out.Port
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrainJobStatusServer.
func (in *TrainJobStatusServer) DeepCopy() *TrainJobStatusServer {
	if in == nil {
		return nil
	}
	out := new(TrainJobStatusServer)
