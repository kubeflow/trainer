...
type Runtime interface {
	...
	RuntimeInfo(ctx context.Context, trainJob *trainer.TrainJob, runtimeTemplateSpec any, mlPolicy *trainer.MLPolicy, podGroupPolicy *trainer.PodGroupPolicy) (*Info, error)
