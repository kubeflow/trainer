...
class TrainerV1alpha1ModelInitializer(BaseModel):
    """
    DatasetInitializer represents the desired configuration to initialize pre-trained model. The DatasetInitializer spec will override the runtime Job template which contains this label: `trainer.kubeflow.org/trainjob-ancestor: dataset-initializer`
    """ # noqa: E501
