...
class TrainerV1alpha1OutputModel(BaseModel):
    """
    OutputModel represents the desired trained model configuration.
    """ # noqa: E501
    env: Optional[List[V1EnvVar]] = Field(default=None, description="List of environment variables to set in the model exporter container. These values will be merged with the TrainingRuntime's model exporter environments.")
    secret_ref: Optional[V1LocalObjectReference] = Field(default=None, alias="secretRef")
    storage_uri: Optional[StrictStr] = Field(default=None, description="Storage uri for the model exporter.", alias="storageUri")
