...
trainer_v1alpha1_train_job_spec_instance = TrainerV1alpha1TrainJobSpec.from_json(json)
# print the JSON string representation of the object
print(TrainerV1alpha1TrainJobSpec.to_json())

# convert the object into a dict
trainer_v1alpha1_train_job_spec_dict = trainer_v1alpha1_train_job_spec_instance.to_dict()
# create an instance of TrainerV1alpha1TrainJobSpec from a dict
trainer_v1alpha1_train_job_spec_from_dict = TrainerV1alpha1TrainJobSpec.from_dict(trainer_v1alpha1_train_job_spec_dict)
```
