...
io_k8s_api_autoscaling_v2_resource_metric_source_instance = IoK8sApiAutoscalingV2ResourceMetricSource.from_json(json)
# print the JSON string representation of the object
print(IoK8sApiAutoscalingV2ResourceMetricSource.to_json())

# convert the object into a dict
io_k8s_api_autoscaling_v2_resource_metric_source_dict = io_k8s_api_autoscaling_v2_resource_metric_source_instance.to_dict()
# create an instance of IoK8sApiAutoscalingV2ResourceMetricSource from a dict
io_k8s_api_autoscaling_v2_resource_metric_source_from_dict = IoK8sApiAutoscalingV2ResourceMetricSource.from_dict(io_k8s_api_autoscaling_v2_resource_metric_source_dict)
```
