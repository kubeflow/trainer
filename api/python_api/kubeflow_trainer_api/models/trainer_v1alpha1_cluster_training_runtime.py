...
class TrainerV1alpha1ClusterTrainingRuntime(BaseModel):
    ...
    metadata: Optional[IoK8sApimachineryPkgApisMetaV1ObjectMeta] = Field(default=None, description="metadata of the ClusterTrainingRuntime.")
    spec: TrainerV1alpha1TrainingRuntimeSpec = Field(description="spec of the ClusterTrainingRuntime.")
