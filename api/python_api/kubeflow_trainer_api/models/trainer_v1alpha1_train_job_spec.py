...
class TrainerV1alpha1TrainJobSpec(BaseModel):
    ...
    pod_spec_overrides: Optional[List[TrainerV1alpha1PodSpecOverride]] = Field(default=None, description="podSpecOverrides defines PodSpec overrides for the training runtime.", alias="podSpecOverrides")
