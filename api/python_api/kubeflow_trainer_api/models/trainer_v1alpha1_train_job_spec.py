...
class TrainerV1alpha1TrainJobSpec(BaseModel):
    ...
    pod_template_overrides: Optional[List[TrainerV1alpha1PodTemplateOverride]] = Field(default=None, description="Custom overrides for the training runtime.", alias="podTemplateOverrides")
