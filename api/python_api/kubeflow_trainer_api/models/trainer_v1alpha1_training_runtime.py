...
class TrainerV1alpha1TrainingRuntime(BaseModel):
    ...
    metadata: Optional[IoK8sApimachineryPkgApisMetaV1ObjectMeta] = Field(default=None, description="metadata of the TrainingRuntime.")
    spec: TrainerV1alpha1TrainingRuntimeSpec = Field(description="spec of the TrainingRuntime.")
