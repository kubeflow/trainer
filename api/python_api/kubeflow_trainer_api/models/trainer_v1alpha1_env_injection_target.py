...
class TrainerV1alpha1EnvInjectionTarget(BaseModel):
    """
    EnvInjectionTarget specifies a replicated job and the containers within it that should receive PET_* env injection.
    """ # noqa: E501
    container_names: List[StrictStr] = Field(description="containerNames lists the container names within the target job that should receive PET_* envs. The item limit keeps admission checks small while covering typical preflight and sidecar use cases.", alias="containerNames")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainerV1alpha1EnvInjectionTarget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainerV1alpha1EnvInjectionTarget from a dict"""
        if obj is None:
            return None
