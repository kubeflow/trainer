...
class TrainerV1alpha1PodTemplateOverride(BaseModel):
    ...
    """ # noqa: E501
    manager: Optional[StrictStr] = Field(default=None, description="manager indicates who created this PodTemplateOverride object. This can be used by external controllers (such as Kueue) or admission webhooks to track which entries they own and avoid conflicts with other controllers.")
