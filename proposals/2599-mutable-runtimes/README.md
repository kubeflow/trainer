...
- 2026-06-22 Creation date
- 2026-09-02 Clarified that the snapshot must capture the effective runtime after
  `RuntimeDefaults` are merged ([KEP-2170](../2170-kubeflow-trainer-v2/README.md#initializer-defaults-via-runtimedefaults))
